...
var _user$project$Skeleton$footer = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html$text('All code is written in Elm and is inspired by the following site:  '),
			A2(
			_elm_lang$html$Html$a,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('grey-link'),
					_elm_lang$html$Html_Attributes$href('https://github.com/elm-lang/elm-lang.org/')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Check it out')
				]))
		]));
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									A2(_user$project$Skeleton_ops['=>'], 'tab', true),
									A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(_user$project$Skeleton_ops['=>'], 'position', 'absolute'),
								A2(_user$project$Skeleton_ops['=>'], 'left', '1em'),
								A2(_user$project$Skeleton_ops['=>'], 'top', '1em')
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$src('./black-white-logo.PNG'),
								_elm_lang$html$Html_Attributes$style(
								_elm_lang$core$Native_List.fromArray(
									[
										A2(_user$project$Skeleton_ops['=>'], 'width', '24px')
									]))
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
...
var _user$project$Skeleton$skeleton = F2(
	function (tabName, content) {
		return A2(
			...
			A2(
				_elm_lang$core$List_ops['::'],
				_user$project$Skeleton$header(tabName),
				A2(
					_elm_lang$core$Basics_ops['++'],
					content,
					_elm_lang$core$Native_List.fromArray(
						[_user$project$Skeleton$footer]))));
	});

var _user$project$Geo$stringAltitude = function (alt) {
	var _p0 = alt;
	if (_p0.ctor === 'Nothing') {
		...
		return A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					' accuracy: ',
					_elm_lang$core$Basics$toString(_p1.accuracy))));
	}
};
var _user$project$Geo$moveTranslate = function (mov) {
	var _p2 = mov;
	if (_p2.ctor === 'Nothing') {
		return {speed: 0, degreesFromNorth: 0};
	} else {
		var _p3 = _p2._0;
		if (_p3.ctor === 'Static') {
			return {speed: 0, degreesFromNorth: 0};
			...
			var _p4 = _p3._0;
			return {speed: _p4.speed, degreesFromNorth: _p4.degreesFromNorth};
		}
	}
};
var _user$project$Geo$stringMovement = function (mov) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'speed: ',
		A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(mov.speed),
			A2(
				_elm_lang$core$Basics_ops['++'],
				' degrees from north: ',
				_elm_lang$core$Basics$toString(mov.degreesFromNorth))));
};
var _user$project$Geo$update = F2(
	function (msg, model) {
		var _p5 = msg;
		switch (_p5.ctor) {
			case 'ChangeLoc':
				...
				if (_p6.ctor === 'Nothing') {
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								latitude: _p7.latitude,
								longitude: _p7.longitude,
								accuracy: _p7.accuracy,
								altitude: _elm_lang$core$Maybe$Nothing,
								movement: _user$project$Geo$moveTranslate(_p7.movement),
								timestamp: _elm_lang$core$Time$inSeconds(_p7.timestamp)
							}),
						_elm_lang$core$Native_List.fromArray(
							[]));
				}
			...
			default:
				return _elm_lang$core$Native_Utils.crashCase(
					...
					_p5)('Unexpected case in update');
		}
	});
var _user$project$Geo$emptyMove = {speed: 0, degreesFromNorth: 0};
var _user$project$Geo$emptyModel = {latitude: 0, longitude: 0, accuracy: 0, altitude: _elm_lang$core$Maybe$Nothing, movement: _user$project$Geo$emptyMove, timestamp: 0};
var _user$project$Geo$init = function (savedModel) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		A2(_elm_lang$core$Maybe$withDefault, _user$project$Geo$emptyModel, savedModel),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
var _user$project$Geo_ops = _user$project$Geo_ops || {};
_user$project$Geo_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _user$project$Geo$size = F2(
	function (height, padding) {
		return _elm_lang$html$Html_Attributes$style(
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					_user$project$Geo_ops['=>'],
					'font-size',
					A2(
						_elm_lang$core$Basics_ops['++'],
...
var _user$project$Geo$locSection = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_user$project$Geo_ops['=>'], 'background-color', '#444D4C'),
						A2(_user$project$Geo_ops['=>'], 'color', 'white')
					])),
				A2(_user$project$Geo$size, 20, 28)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('Geolocation Information'),
				A2(
				_elm_lang$html$Html$ul,
				_elm_lang$core$Native_List.fromArray(
					[]),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'altitude: ',
									_user$project$Geo$stringAltitude(model.altitude)))
							])),
						A2(
						_elm_lang$html$Html$li,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'speed: ',
									_user$project$Geo$stringMovement(model.movement)))
							])),
						A2(
						_elm_lang$html$Html$li,
						_elm_lang$core$Native_List.fromArray(
...
var _user$project$Geo$view = function (model) {
	return A2(
		_user$project$Skeleton$skeleton,
		'home',
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Geo$locSection(model)
			]));
};
var _user$project$Geo$Model = F6(
	function (a, b, c, d, e, f) {
		return {latitude: a, longitude: b, accuracy: c, altitude: d, movement: e, timestamp: f};
	});
var _user$project$Geo$Mov = F2(
	function (a, b) {
		return {speed: a, degreesFromNorth: b};
	});
var _user$project$Geo$ShowChange = {ctor: 'ShowChange'};
var _user$project$Geo$ChangeLoc = function (a) {
	return {ctor: 'ChangeLoc', _0: a};
};
var _user$project$Geo$locationSend = function (loc) {
	return _user$project$Geo$ChangeLoc(
		_elm_lang$core$Maybe$Just(loc));
};
var _user$project$Geo$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{
			init: _user$project$Geo$init,
			view: _user$project$Geo$view,
			update: _user$project$Geo$update,
			subscriptions: function (_p9) {
				return _elm_lang$geolocation$Geolocation$changes(_user$project$Geo$locationSend);
			}
		}),
											...
											function (longitude) {
												return A2(
													...
													A2(
														...
														A2(
															_elm_lang$core$Json_Decode$andThen,
															A2(_elm_lang$core$Json_Decode_ops[':='], 'degreesFromNorth', _elm_lang$core$Json_Decode$float),
															function (degreesFromNorth) {
																return A2(
																	_elm_lang$core$Json_Decode$andThen,
													...
													function (movement) {
														return A2(
															...
															function (timestamp) {
																return _elm_lang$core$Json_Decode$succeed(
																	{accuracy: accuracy, altitude: altitude, latitude: latitude, longitude: longitude, movement: movement, timestamp: timestamp});
															});
													});
											});
									});
...
var _user$project$Geo$NoOp = {ctor: 'NoOp'};

var Elm = {};
Elm['Geo'] = Elm['Geo'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Geo'], 'Geo', typeof _user$project$Geo$main === 'undefined' ? null : _user$project$Geo$main);
